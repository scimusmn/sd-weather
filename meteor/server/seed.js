...
if (Locations.find().count() === 0) {
    ...
    Locations.insert({
        ...
        order: 0,
        title: 'San Diego',
        description: 'Galph korsa ozlint arka arul brul qi galph lydran. Pank ma gronk prinquis, ux nalista flim morvit gronk menardis zorl ma brul obrikt twock arul.',
        latitude: '32.732323',
